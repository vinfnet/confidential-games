...
# and forked from the main ACC repo https://github.com/Azure-Samples/confidential-computing

# This script uses community contributed images from dockerhub, please check the image before using it in production
# https://hub.docker.com/r/b0nam/docker-doom
# This script creates a Confidential Azure Container Instance with a simple container that runs the game Doom, it uses the latest image
# You can connect to the container using a VNC client, the IP address is displayed at the end of the script
# The password for the VNC session is PASSWORD

# Clone this repo to a folder
#
# Usage: ./BuildRandomDoomACI.CVM.ps1 -subsID <YOUR SUBSCRIPTION ID> -basename <YOUR BASENAME>
#
...
# TO DO
# add ability to pass the VNC password as a parameter
